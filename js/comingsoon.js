...
$(document).ready(function () {
	"use strict";
    // Countdown
	$('#timer').countdown('2016/06/20', function (event) { //set date YYYY/MM/DD or YYYY/MM/DD HH:MM:SS
		var format = "<div class='col-xs-6 col-sm-1'><span>%D</span> days</div>" + "<div class='col-xs-6 col-sm-1'><span>%H</span> hours</div>" + "<div class='col-xs-6 col-sm-1'><span>%M</span> minutes</div>" + "<div class='col-xs-6 col-sm-1'><span>%S</span> seconds</div>";
